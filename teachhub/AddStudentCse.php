...
,
  ...
  <form action="AddStudentCseInDatabase.php" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="roll" name="studentemail">
  </div>

  <div class="form-group">
    <label for="NUMBER">CLOUD COMPUTING MARKS:</label>
  ...
  <div class="form-group">
    <label for="cd">COMPILER DESIGN MARKS:</label>
  ...
  <div class="form-group">
    <label for="cn">COMPUTER NETWORKS MARKS:</label>
