...
<br/>
  ...
  <form action="AddStudentItInDatabase.php" method="POST">
  ...
  <div class="form-group">
    <label for="NUMBER">FLOWCONTROLS MARKS:</label>
    <input type="NUMBER" class="form-control" id="NUMBER" name="flow">
  </div>

  <div class="form-group">
    <label for="dbms">OBJECT ORIENTED PROGRAMMING(JAVA) MARKS:</label>
    <input type="NUMBER" class="form-control" id="NUMBER" name="java">
  </div>


  <div class="form-group">
    <label for="cd">SHELL SCRIPTING MARKS:</label>
  ...
  <div class="form-group">
    <label for="cn">FORMAL LANGUAGE & AUTOMATA THEORY MARKS:</label>
  ...
  <div class="form-group">
    <label for="cn">ENGINEERING PHYSICS MARKS:</label>
    <input type="NUMBER" class="form-control" id="cn" name="phy">
  </div>


  <div class="form-group">
    <label for="cn">HUMANITIES MARKS:</label>
